...
<html>
  ...
  <form action="form_ok.jsp" method="post">
    <fieldset style="width: 600px; margin: 15px">
      ...
      <option value="5"><%="카마이클"%></option>
      <option value="6"><%="열송학사"%></option>
    </select>
      <br /><br />
      <%="학부: "%> <select name="major">
      ...
      <br /><br />
      <%="정보를 저장하는 것에 동의하나요?"%> <input name="agree" type="checkbox"/>
    </fieldset>
